...
e1 <- rev(c(2.6,4.4,7.6,8.1,8.9)); #there are three line per column, the mean obj size changes per line as follows: 30, 45, 60
...
pdf(file="output/packet_based_bwd.pdf", 
...
lines(x_at,e1, type="o", pch=18, lty=1, 
