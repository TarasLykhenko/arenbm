...
run: release
	time java -Xmx2g -cp "$(PSDIR)/djep-1.0.0.jar:$(PSDIR)/jep-2.3.0.jar:bbones.jar:$(PSDIR)/peersim-1.0.5.jar:$(PSDIR)/colt.jar" peersim.Simulator ./general/config_file.cfg #> run.log 2>&1
